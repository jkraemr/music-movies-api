...
The RESTful **Music Movies API** is the complete server-side component of the **myMusicMovies** web applications built using the MERN or MEAN stack.  

The **Music Movies API** provides users with access to details about music movies including respective genres and directors. Users will be able to sign up, update their personal information, and create a list of their favorite music movies.
